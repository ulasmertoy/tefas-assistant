...
def _to_fund(code, row) -> FundRecommendation:
    ...
    return FundRecommendation(
        ...
        return_1m=_num_or_none(row.get("return_1m")),
        return_3m=_num_or_none(row.get("return_3m")),
        return_6m=_num_or_none(row.get("return_6m")),
        return_ytd=_num_or_none(row.get("return_ytd")),
